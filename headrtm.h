...
void ini_model_minea(float *vp, float *vpn, int ntp, int ntz, int ntx, int pml, int flag);
...
void input_parameters(int *nx,int *nz,int *pml,int *Lc,float *dx,float *dz,int *itmax,float *dt,float *f0, 
		...
		);//int *r_n, float *rx0,float *recdx, 

extern "C"
void hilbert_transform1d(float *rick, float *rick_hilbert, int i, 
		int itmax);
